...
function dipositeMoney(user) {
  readline.question("how much money do you want to deposit? ", (Amount) => {
    try {
...
function withdrawMoeney(user) {
  readline.question("how much money do you want to withdraw? ", (Amount) => {
    try {
      Amount = parseFloat(Amount);
      let users = loadUsers();
      console.log("ur old balance was " + user.balance);
